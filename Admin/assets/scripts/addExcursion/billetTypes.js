...
function createBilletTypeBlock() {
  ...
  imgSelectorArrow.setAttribute("src", "assets/images/arrow_down_dark.svg");
  ...
  imgRub.setAttribute("src", "assets/images/rub.svg");
  ...
  imgTrash.setAttribute("src", "assets/images/trash.svg");
